...
def visualize_segmentation(**kwargs):
    ...
    kwargs : @img,@lbl_true,@lbl_pred,@n_class,@label_name
    return : the (2,1) image (each have h,w,c dimension) for segmentation
    Parameters
    ----------
    img: ndarray
    ...
    if lbl_true is not None:
        #make value equal to -1 to underground
...
if __name__ =="__main__":
    label = Image.open("../datasets/VOCdevkit/VOC2012/SegmentationClass/2007_000033.png")
    img = Image.open("../datasets/VOCdevkit/VOC2012/JPEGImages/2007_000033.jpg")
    ...
    label2rgb(label,img=img,label_names = class_names,n_labels = 21)
